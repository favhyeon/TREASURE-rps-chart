 ...
 */
const pairNames = [
    ["최최", "최쥰", "최욧", "최준", "최혁", "최샇", "최뎡", "최뤁", "최늑", "최환"],
    ["쥰최", "쥰쥰", "쥰욧", "쥰준", "쥰혁", "쥰샇", "쥰뎡", "쥰뤁", "쥰늑", "쥰환"],
    ["욧최", "욧쥰", "욧욧", "욧준", "욧혁", "욧샇", "욧뎡", "욧뤁", "욧늑", "욧환"],
    ["준최", "준쥰", "준욧", "준준", "준혁", "준샇", "준뎡", "준뤁", "준늑", "준환"],
    ["혁최", "혁쥰", "혁욧", "혁준", "혁혁", "혁샇", "혁뎡", "혁뤁", "혁늑", "혁환"],
    ["샇최", "샇쥰", "샇욧", "샇준", "샇혁", "샇샇", "샇뎡", "샇뤁", "샇늑", "샇환"],
    ["뎡최", "뎡쥰", "뎡욧", "뎡준", "뎡혁", "뎡샇", "뎡뎡", "뎡뤁", "뎡늑", "뎡환"],
    ["뤁최", "뤁쥰", "뤁욧", "뤁준", "뤁혁", "뤁샇", "뤁뎡", "뤁뤁", "뤁늑", "뤁환"],
    ["늑최", "늑쥰", "늑욧", "늑준", "늑혁", "늑샇", "늑뎡", "늑뤁", "늑늑", "늑환"],
    ["환최", "환쥰", "환욧", "환준", "환혁", "환샇", "환뎡", "환뤁", "환늑", "환환"]
];
...
const CUSTOM_COLOR_KEY = "treasure-custom-colors";
...
const SELF_PAIR_KEY = "treasure-include-selfpair";
...
saveBtn.addEventListener("click", async () => {
    ...
    try {
        ...
        const fileLabel = currentTab === "rps" ? "틎페스_취향표" : "공수_취향표";

        const link = document.createElement("a");
        link.href = currentBlobUrl;
        link.download = `TREASURE_${fileLabel}.png`;
